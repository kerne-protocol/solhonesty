...
Snapshot generated 2026-08-20T07:29:30.565Z. Window 30 days.
...
| --- | --- | --- | --- | --- | --- |
| Kamino Lend USDC (Main market) | 4.5056 | 4.3342 | 0.1714 | 96.2 | issuer_share_price_history |
| Kamino Lend USDG (Main market) | 2.9878 | 2.5782 | 0.4096 | 86.29 | issuer_share_price_history |
| Kamino Lend PYUSD (Main market) | 4.4255 | 4.2248 | 0.2006 | 95.47 | issuer_share_price_history |
| Kamino Lend USDT (Main market) | 3.475 | 3.396 | 0.079 | 97.73 | issuer_share_price_history |
| Kamino Lend USDS (Main market) | 4.0541 | 4.2053 | -0.1512 | 103.73 | issuer_share_price_history |
| Save USDC (Main pool) | 2.32 | 2.4154 | -0.0954 | 104.11 | onchain_share_price |
| Save USDT (Main pool) | 1.39 | 1.435 | -0.045 | 103.23 | onchain_share_price |
| Jupiter Lend Earn USDC | 4.1121 | 4.9084 | -0.7963 | 119.36 | issuer_share_price_observed |
| Jupiter Lend Earn JupUSD | 4.2788 | 5.3506 | -1.0718 | 125.05 | issuer_share_price_observed |
| Jupiter Lend Earn USDT | 3.1897 | 3.4838 | -0.2941 | 109.22 | issuer_share_price_observed |
| Jupiter Lend Earn USDS | 3.7691 | 3.511 | 0.2581 | 93.15 | issuer_share_price_observed |
| Jupiter Lend Earn USDG | 5.6536 | 4.8795 | 0.7741 | 86.31 | issuer_share_price_observed |
| Jupiter Lend Earn EURC | 3.3136 | 3.5339 | -0.2203 | 106.65 | issuer_share_price_observed |

Widest gap among rows this board can rank: kamino-lend-usdt, at 0.31 percent against the median of its own advertised history.
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| Kamino Lend USDC (Main market) | 4.5056 | 3.2082 | 3.9288 | 32.5613 | 10.15x | 95.7 | -0.4054 |
| Kamino Lend USDG (Main market) | 2.9878 | 1.8958 | 2.486 | 3.0838 | 1.63x | 94.6 | -0.0922 |
| Kamino Lend PYUSD (Main market) | 4.4255 | 2.4132 | 4.1023 | 9.0069 | 3.73x | 61.8 | -0.1225 |
| Kamino Lend USDT (Main market) | 3.475 | 2.2113 | 3.7028 | 14.4288 | 6.53x | 42 | 0.3068 |
| Kamino Lend USDS (Main market) | 4.0541 | 3.9399 | 4.145 | 4.7902 | 1.22x | 33 | -0.0603 |
...
| Jupiter Lend Earn USDC | 4.1121 | not published | not published | not published | n/a | n/a | n/a |
| Jupiter Lend Earn JupUSD | 4.2788 | not published | not published | not published | n/a | n/a | n/a |
| Jupiter Lend Earn USDT | 3.1897 | not published | not published | not published | n/a | n/a | n/a |
| Jupiter Lend Earn USDS | 3.7691 | not published | not published | not published | n/a | n/a | n/a |
| Jupiter Lend Earn USDG | 5.6536 | not published | not published | not published | n/a | n/a | n/a |
| Jupiter Lend Earn EURC | 3.3136 | not published | not published | not published | n/a | n/a | n/a |
...
**2 row(s) in this snapshot were captured outside the middle half of their own recent range** (kamino-lend-usdc, kamino-lend-usdg). For those rows, prefer `gap_vs_median_pct` over `gap_pct`.
...
The products below are picked out of **this snapshot**, closest to exact delivery first, rather than typed into this file. Today the rows landing nearest their own advertised rate are **Kamino Lend USDT (Main market)** (97.73 percent of what it advertises) and **Kamino Lend USDS (Main market)** (103.73 percent of what it advertises).
